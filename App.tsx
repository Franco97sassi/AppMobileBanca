...
export default function App() {
  ...
  const content = screen === 'home' ? <HomeScreen transactions={transactions} goTransfer={() => setScreen('transfer')} goActivity={() => setScreen('activity')} /> : screen === 'activity' ? <ActivityScreen transactions={transactions} /> : screen === 'transfer' ? <TransferScreen onSubmit={transfer} /> : screen === 'cards' ? <CardsScreen /> : <ProfileScreen logout={logout} />;
